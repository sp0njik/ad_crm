...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('start_at', models.DateField(verbose_name='Дата начала размещения')),
                ('duration', models.DurationField(verbose_name='Продолжительность размещения')),
                ('invoice', models.FileField(blank=True, upload_to='files', verbose_name='счет на оплату')),
                ('reconciliation', models.FileField(blank=True, null=True, upload_to='files', verbose_name='Акт сверки')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='placements', to=settings.AUTH_USER_MODEL, verbose_name='Организация')),
